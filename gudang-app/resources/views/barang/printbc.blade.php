...
<div class="barcode">
    <img src="data:image/png;base64,{{ DNS1D::getBarcodePNG($barang->id, 'C39', 2, 60, [1,1,1], true) }}" alt="barcode">
    <p style="font-size: 16px; font-weight: bold; margin-top: 5px;">{{ $barang->id }}</p>
</div>


    <hr>
    <p><em>Barcode Barang</em></p>
